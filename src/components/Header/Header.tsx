	...
	return (
		<header className="bg-black text-white whitespace-normal m-3 rounded-md sticky">
			<nav className="container mx-auto flex items-center justify-between py-4">
				<Image src="/outer_space.png" width={100} height={40} alt="my logo" className="object-contain"/>
				<Link href="/">
					<div className="text-2xl font-semibold px-2 hover:text-violet-400 font-mono">Outer Space/*</div>
				</Link>
